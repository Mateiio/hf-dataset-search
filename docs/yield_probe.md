...
Run 2026-09-13 by `python -m edisearch.evalset.yield_probe`, n = 50, seed 0, sampled uniformly from 6,871 distinct (dataset, paper) pairs in DataCite. Mechanical yield only: whether the paper could be read and whether it names the dataset. **Whether a sentence describes what the dataset contains is a human call and the column for it is empty below.**
...
| ... via open PDF | 10 | |
| Dataset named unambiguously (DOI, package id or title) | 11 | 22% |
| ... with at least one hit in the body text | 9 | 18% |
| ... hits only in the reference list (body sentence still to be resolved) | 2 | 4% |
| Only a weak pointer (author-year or a generic EDI mention) | 0 | 0% |
...
By link source (a pair can be in both): `is-cited-by` none 23, doi 11; `references` none 19, doi 3
...
- **doi**, body [8705–8755]: 70ac5c1af71 e6f3; https:// doi.org/10.6073 /pasta/
- **doi**, reference list [64763–64799]: Available from: https://doi.or g/10.
- **Verdict:** 
...
- **doi**, body [57491–57554]: https://doi.org/10.6073/pasta/a5a4d4154e0a8181a5523b4d9c49ed99
- **title**, body [57321–57376]: Measurements of Leaf area, foliar C and N for 14 sites
- **Verdict:** 
...
- **doi**, reference list [109793–109856]: https://doi.org/10.6073/pasta/f5740876b68ec42b695c39d8ad790cee,
- **title**, reference list [109701–109731]: B.: Water isotope samples from
- **author_year**, body [15160–15216]: at the precipitation sampler (564 m; Campbell and Green,
- **author_year**, body [19020–19102]: Watershed 3, Hubbard Brook Experimental Forest (data of Campbell and Green, 2019).
- **Verdict:** 
...
- **Text:** europepmc, 54,322 chars
- **doi**, reference list [52748–52915]: MCR LTER: Coral Reef: Long-term Population and Community Dynamics: Corals, ongoing since 2005. knb-lter-mcr.4.33 10.6073/pasta/1f05f1f52a2759dc096da9c24e88b1e8 (2015).
- **Verdict:** 
...
- **Text:** europepmc, 47,532 chars
- **doi**, body [29259–29441]: Those data sources are listed and acknowledged in file Metadata- Sampling Locations.csv included in our data package: https://doi.org/10.6073/pasta/dd706bbd8bae2386517d3bf20be02396 .
- **doi**, body [30769–30955]: All chlorophyll a time series data used in this study have been deposited at the Environmental Data Initiative ( https://doi.org/10.6073/pasta/dd706bbd8bae2386517d3bf20be02396 ) ( 37 ).
- **doi**, body [37918–37996]: Environmental Data Initiative. 10.6073/pasta/dd706bbd8bae2386517d3bf20be02396.
- **title**, body [37789–37917]: Cloern J., Jassby A., “Multidecadal Time Series of Measured Chlorophyll-a in Lakes and Estuarine-Coastal Ecosystems, 1966-2024”.
- **title**, reference list [46205–46333]: Cloern J., Jassby A., “Multidecadal Time Series of Measured Chlorophyll-a in Lakes and Estuarine-Coastal Ecosystems, 1966-2024”.
- **Verdict:** 
...
- **doi**, body [26956–27044]: at https://doi.org/10.6073/pasta/1688bdf9c001c89972d2cb53d242c4ef (Accessed 2021-08-02).
- **Verdict:** 
...
- **doi**, reference list [6426–6494]: URL: https://doi.org/10.6073/pasta/74775c4af51c237f2a20e4a8c011bc53
- **Verdict:** 
...
- **doi**, body [72018–72062]: Andrews LTER: https://doi.org/10.6073/pasta/
- **doi**, reference list [91765–91826]: Environmental Data Initiative, https://doi.org/10.6073/pasta/
- **title**, reference list [91664–91764]: A.: Meteorological data from benchmark stations at the Andrews Experimental Forest, 1957 to present,
- **Verdict:** 
...
- **doi**, body [42256–42356]: Environmental Data Initiative, https://doi.org/10.6073/pasta/42727d38837cb4bdf04ce4e0d158ea92, 2020.
- **Verdict:** 
...
- **doi**, reference list [41693–41757]: https://doi.org/10.6073/pasta/ab7c87401f08db2e682b428e524fec03.
- **title**, reference list [41529–41604]: PIE LTER predation and herbivory rates associated with marsh sites used in
- **author_year**, body [22448–22493]: Three studies (Byrnes 2019, 2021, 2022) were
- **author_year**, reference list [51592–51625]: Data from: Byrnes 2019 and 2021.
- **Verdict:** 
...
- **doi**, body [51873–51924]: org/10.6073/pasta/5683662180499904732e654e3869f3e6.
- **doi**, reference list [56641–56693]: https://doi.org/10.6073/pasta/5683662180499904732e65
- **title**, reference list [56473–56514]: “American Residential Macrosystems — Soil
- **author_year**, body [19088–19105]: (Groffman, 2019).
- **Verdict:** 
